      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed top-0 right-0 z-[100] h-screen bg-white shadow-2xl border-l border-gray-100 flex flex-col ${isResizing ? 'select-none transition-none' : ''}`}
          >
            {/* Resize Handle */}
            <div
              onMouseDown={startResizing}
              className="absolute left-0 top-0 bottom-0 w-1.5 cursor-col-resize hover:bg-primary/20 transition-colors group z-50 flex items-center justify-center translate-x-[-50%]"
            >
              <div className="w-[3px] h-8 bg-gray-200 rounded-full group-hover:bg-primary/40" />
            </div>
